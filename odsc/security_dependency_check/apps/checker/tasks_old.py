...
#     # Close temp dir
#     # -------------------------------------------------------------------------
#     curr_dir = os.path.join(os.path.dirname(__file__), "_temp",
#                             uuid.uuid4().hex) + "/"
#
#     while True:
...
#         log.error("File '{}' was not generated by Java :( ".format(curr_dir))
#
...
#
#     if not os.path.exists(curr_dir):
#         log.error("File '{}' XXXXXX".format(curr_dir))
#     # return
#     tree = ET.parse('{}/dependency-check-report.xml'.format(curr_dir))
#     root = tree.getroot()
#     cleared_results = {}
#
#     SCHEME = "{https://jeremylong.github.io/DependencyCheck" \
#              "/dependency" \
#              "-check.1.3.xsd}"
#
...
#     if not os.path.exists(curr_dir):
#         log.error(
#             "File '{}' was not generated by Retire :( ".format(curr_dir))
#
#         current_app.config["REDIS"]. \
#             decr("ODSC_{}_counter".format(project_id))
#
